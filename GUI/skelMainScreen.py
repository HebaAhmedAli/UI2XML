...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("Resources/Images/exit-white.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionExit.setIcon(icon1)
        self.actionExit.setObjectName("actionExit")
        self.actionGenerateXML = QtWidgets.QAction(mainWindow)
        self.actionGenerateXML.setEnabled(False)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("Resources/Images/run-white.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionGenerateXML.setIcon(icon2)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("Resources/Images/connect-white.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionConnectCmpts.setIcon(icon3)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("Resources/Images/update-white.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionUpdateCmpts.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("Resources/Images/finish-white.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionFinish.setIcon(icon5)
